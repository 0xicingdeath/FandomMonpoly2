    ...
    private void roomOfRequirement() {
        ...
        //************************************************Transportation*
            ...
            if (player[0].getCol() >= 32 && player[0].getCol() <= 5) {
                ...
                if (!square[player[0].getCol()].getOwned()) {
                    ...
                    if (answer == 0) {
                        ...
                        square[player[0].getCol()].setRent(square[player[0].getCol()].getNumber() * square[player[0].getCol()].getRent());
                ...
                else if (square[player[0].getCol()].getOwned() && square[player[0].getCol()].getOwner().equals("Com Pewter")) {
            ...
            //If they are after the tardis; and on or before the taxi.
                ...
                if (!square[player[0].getCol()].getOwned()) {
                    ...
                    if (answer == 0) {
                       // square[player[0].getCol()].setOwner().equals("User");
                        square[player[0].getCol()].setOwned(true);
                        //square[player[0].getCol()].number++;
...
//                                player[0].gringottsAccount-=(square[player[0].getCol()].buy);
            ...
            if (!whoseTurn) {
                ...
                if (square[player[1].getCol()].getOwned() && square[player[1].getCol()].getOwner().equals("User")) {
                    int p;
                ...
                //If the Com Pewter lands on the Room of Requirement
                    ...
                    //************************************************Transportation*
                        ...
                        if (player[1].getCol() >= 32 && player[1].getCol() <= 5) {
                            ...
                            if (false == square[player[1].getCol()].getOwned()) {
...
//                                                                    player[1].gringottsAccount-=(square[player[1].getCol()].buy);
                        ...
                        //If they are after the tardis; and on or before the taxi.
                            ...
                            if (!square[player[1].getCol()].getOwned()) {
                                int answer = (int) ((Math.random() * 10000) + 1);
                ...
                else if (!square[player[1].getCol()].getOwned()) {
